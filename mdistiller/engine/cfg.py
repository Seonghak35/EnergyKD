...
# Energy
CFG.ENERGY = CN()
CFG.ENERGY.LOW_RATE = 0.2
CFG.ENERGY.HIGH_RATE = 0.2
...
# energyKD CFG
CFG.energyKD = CN()
CFG.energyKD.LOSS = CN()
CFG.energyKD.LOSS.CE_WEIGHT = 0.1
CFG.energyKD.LOSS.KD_WEIGHT = 0.9
CFG.energyKD.T = CN()
CFG.energyKD.T.HIGH = 6.0
CFG.energyKD.T.MID = 4.0
CFG.energyKD.T.LOW = 2.0

# energyDKD CFG
CFG.energyDKD = CN()
CFG.energyDKD.CE_WEIGHT = 1.0
CFG.energyDKD.ALPHA = 1.0
CFG.energyDKD.BETA = 8.0
CFG.energyDKD.WARMUP = 20
CFG.energyDKD.T = CN()
CFG.energyDKD.T.HIGH = 6.0
CFG.energyDKD.T.MID = 4.0
CFG.energyDKD.T.LOW = 2.0

# energyAUG CFG
CFG.energyAUG = CN()
CFG.energyAUG.TEMPERATURE = 4
CFG.energyAUG.LOSS = CN()
CFG.energyAUG.LOSS.CE_WEIGHT = 0.1
CFG.energyAUG.LOSS.KD_WEIGHT = 0.9
CFG.energyAUG.AUGMENTATION = 'CUTMIX'
